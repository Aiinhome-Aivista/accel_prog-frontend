...
import { Home, LayoutGrid, BookOpen, GraduationCap, Users, Megaphone, Library, LifeBuoy } from 'lucide-react';
    ...
    <>
      ...
      >
        <div className="p-[0.8rem_0.9rem_0.6rem] border-b border-[#E5DDD4]">
          <div className="text-[0.55rem] font-bold uppercase tracking-[0.06em] text-[#9597A6]">Course 1 · Foundation</div>
          <div className="font-['DM_Serif_Display'] text-[0.85rem] text-[#2B2D42] leading-[1.2]">The AI Consumer & Builder</div>
        </div>
        <div className="flex-1 py-[0.3rem]">
          {NAV_ITEMS.map((n) => {
            ...
            return (
              ...
              >
                <Icon className={`w-[14px] h-[14px] shrink-0 ${isActive ? 'opacity-100' : 'opacity-50'}`} strokeWidth={isActive ? 2 : 1.5} />
